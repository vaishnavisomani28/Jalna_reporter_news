          ...
          <nav className="hidden md:flex items-center space-x-4 lg:space-x-6">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className={`text-base md:text-lg font-medium transition-colors whitespace-nowrap ${
                  pathname === link.href
            ...
            <Link
              href="/write"
              className="flex items-center space-x-2 bg-primary text-white px-4 md:px-5 py-2 md:py-2.5 rounded-lg hover:bg-primary-dark transition-colors font-semibold shadow-md text-sm md:text-base"
            >
